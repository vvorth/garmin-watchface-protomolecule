...
class Face:
    ...
    def draw_time(self, offset_y=0.0, hours_color=None, minutes_color=None):
        ...
        self.text(x, y, self.clock_font, hours, hours_color or HOURS, align="left", family="clock")
        self.text(x + hw + gap, y, self.clock_font, minutes, minutes_color or MINUTES,
                  align="left", family="clock")
    ...
    def draw_sleep_face(self):
        ...
        self.draw_time(offset_y, hours_color=TEXT_DIM, minutes_color=TEXT_DIM)
